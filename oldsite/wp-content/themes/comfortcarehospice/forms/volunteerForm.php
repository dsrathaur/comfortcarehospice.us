...
$formname = 'Become a Hospice Volunteer Form';
...
$areasNeed = array('Fundraising','PR/Marketing','Office Assistance','Volunteer Recruitment','Special Events');
?>
<!DOCTYPE HTML>
<html>
<head>
...
<script>
  ...
  jQuery(document).ready(function() {
	...
	jQuery("form").submit(function() {
		ga('send', 'event', 'volunteerForm', 'submit');
	});
});
...
<body>
	<div id="container" class="rounded-corners">
		<div id="content" class="rounded-corners">
			<form id="submitform" class="volunteerContactFormEvent" name="contact" method="post" action="">				
