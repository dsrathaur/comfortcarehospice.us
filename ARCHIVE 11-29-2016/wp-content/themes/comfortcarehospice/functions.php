...
function twentysixteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Middle A', 'twentysixteen' ),
		'id'            => 'mida',
		'description'   => __( 'Text widget', 'twentysixteen' ),
	...
	register_sidebar( array(
		'name'          => __( 'Middle B', 'twentysixteen' ),
		'id'            => 'midb',
		'description'   => __( 'Text widget', 'twentysixteen' ),
		'before_widget' => '<div class="widget %2$s">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => __( 'Middle C', 'twentysixteen' ),
		'id'            => 'midc',
		'description'   => __( 'Text widget', 'twentysixteen' ),
		'before_widget' => '<div class="widget %2$s">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => __( 'Sidebar Box Top Content', 'twentysixteen' ),
		'id'            => 'sidecon',
		'description'   => __( 'Text widget', 'twentysixteen' ),
		'before_widget' => '<div class="widget %2$s">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => __( 'Bottom Service Areas', 'twentysixteen' ),
		'id'            => 'servareas',
		'description'   => __( 'Text widget', 'twentysixteen' ),
		'before_widget' => '<div class="widget %2$s">',
		'after_widget'  => '</div>',
