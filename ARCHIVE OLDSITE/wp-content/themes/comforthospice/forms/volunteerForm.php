...
<fieldset class="ui-widget ui-widget-content ui-corner-all">
	...
	<table border="0" width="100%"  align="center"  cellpadding="5px;">	
			...
			<tr>
				<td ><font color="#FF0000">*</font>How did you first hear about our program? </td>
				<td align="left" class="ui-widget ui-widget-header2"><?php $input->fields('How_did_you_first_hear_about_our_program','width: 250px;'); ?></td>
			</tr>
			<tr>
				<td ><font color="#FF0000">*</font>Please list any of your special skills and other languages spoken </td>
				<td align="left" class="ui-widget ui-widget-header2"><?php $input->textarea('Please_list_any_of_your_special_skills_and_other_languages_spoken','width: 250px; height: 100px;'); ?></td>
			</tr>
			<tr>
				<td ><font color="#FF0000">*</font>If you have previous volunteer experience please describe it here </td>
				<td align="left" class="ui-widget ui-widget-header2"><?php $input->textarea('If_you_have_previous_volunteer_experience_please_describe_it_here','width: 250px; height: 100px;'); ?></td>
			</tr>
			<tr>
				<td ><font color="#FF0000">*</font>How would you like to receive information from us? </td>
				<td align="left" class="ui-widget ui-widget-header2"><?php $input->fields('How_would_you_like_to_receive_information_from_us','width: 250px;'); ?></td>
			</tr>
			<tr><td>&nbsp;</td></tr>
			<tr><td>&nbsp;</td></tr>
			<tr><td colspan="4" align="center"><strong>Contact Information</strong></td></tr>
			<tr>
			...
			<tr>
				<td ><label for="Telephone">Telephone <span style="color:#FF0000; font-weight:bold;">*</span></label></td>
				<td align="left" class="ui-widget ui-widget-header2"><?php $input->fields('Telephone','width: 250px;'); ?></td>
			</tr>
			<tr>
			...
			<tr>
			  <td><font color="#FF0000">*</font>If you are interested in helping in any of the following areas of need, please select one</td>
			  <td colspan="-1" align="right"><select name="areas_of_need" style="width:254px" >
