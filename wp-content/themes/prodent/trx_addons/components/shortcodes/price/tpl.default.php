		...
		?>>
			...
			?><div class="sc_price_item_info"><?php
				...
				if (!empty($item['link']) && !empty($item['link_text'])) {
					?><a href="<?php echo esc_url($item['link']); ?>" target="_blank" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_price_item_link_classes', 'sc_price_item_link sc_button')); ?>"><?php
