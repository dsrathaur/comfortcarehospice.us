<?php
/**
 * The style "accented" of the Iconed text
 *
 * @package WordPress
...
?><div<?php if (!empty($args['id'])) echo ' id="'.esc_attr($args['id']).'"'; ?> class="sc_layouts_iconed_text sc_layouts_iconed_text_accented<?php
	...
	if (!empty($args['text1']) || !empty($args['text2']) || !empty($args['icon'])) {
