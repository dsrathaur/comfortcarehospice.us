...
body .sc_icons_item.sc_icons_item_linked a[href*="tel:"] {
...
body .promo .sc_action_content .sc_action_item_simple.sc_action_item_ml a[href*="tel:"]:hover {
	color: {$colors['text_link2']} !important;
}

body .sc_action_content > .sc_action_item_default.sc_action_item_ml a[href*="tel:"],
body .sc_action_content > .sc_action_item_simple.sc_action_item_mc  a[href*="tel:"],
body .sc_action_content > .sc_action_item_simple.sc_action_item_ml  a[href*="tel:"]{
	color: {$colors['bg_color']};
}
body .sc_action_content > .sc_action_item_default.sc_action_item_ml a[href*="tel:"]:hover,
body .sc_action_content > .sc_action_item_simple.sc_action_item_mc  a[href*="tel:"]:hover,
body .sc_action_content > .sc_action_item_simple.sc_action_item_ml  a[href*="tel:"]:hover{
	color: {$colors['text_link']} !important;
}
