...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	...
	if (PRODENT_STORAGE['button_hover'] && PRODENT_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.prodent_tabs .prodent_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				.woocommerce .button:not(.add_to_cart_button):not([class*="shop_"]):not([class*="view"]):not([class*="sc_button_hover_"]),\
				.woocommerce-page .button:not(.add_to_cart_button):not([class*="shop_"]):not([class*="view"]):not([class*="sc_button_hover_"]),\
				#buddypress a.button:not([class*="sc_button_hover_"])\
				').addClass('sc_button_hover_just_init sc_button_hover_'+PRODENT_STORAGE['button_hover']);
		if (PRODENT_STORAGE['button_hover']!='arrow') {
		...
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.prodent_tabs .prodent_tabs_titles li a:not([class*="sc_button_hover_style_"])\
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+PRODENT_STORAGE['button_hover']);
