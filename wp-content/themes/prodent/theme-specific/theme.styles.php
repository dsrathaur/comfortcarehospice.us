...
footer .select_container:before, footer .select_container select  {
    background-color: {$colors['input_bg_color']} !important;
}
footer .select_container:focus:before, footer .select_container:hover:before, footer .select_container select:focus  {
    background-color: {$colors['input_bg_color']} !important;
}
...
.header_position_over .top_panel .scheme_self.sc_layouts_row_type_compact .sc_layouts_item a:not(.sc_button):not(.button) {
	color: {$colors['text_dark']};
}
...
.footer_wrap .widget input[type="search"]:hover {
    border-color: {$colors['text_link']};
}
...
body table.booked-calendar .booked-appt-list .timeslot .timeslot-people button .spots-available{
    color: {$colors['bg_color']};
}
