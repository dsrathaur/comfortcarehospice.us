...
// Current version
if ( ! defined( 'TRX_ADDONS_VERSION' ) ) define( 'TRX_ADDONS_VERSION', '1.6.35.1' );
...
if ( ! function_exists( 'prodent_trx_addons_privacy_text' ) ) {
    add_filter( 'trx_addons_filter_privacy_text', 'prodent_trx_addons_privacy_text' );
    function prodent_trx_addons_privacy_text( $text='' ) {
        return prodent_get_privacy_text();
    }
}
