...
?><a href="<?php echo empty(prodent_get_theme_option('logo_link')) ? esc_url(home_url('/')) : esc_url(prodent_get_theme_option('logo_link')); ?>"<?php
		if (!empty($args['id'])) echo ' id="'.esc_attr($args['id']).'"';
		?> class="111 sc_layouts_logo sc_layouts_logo_<?php
