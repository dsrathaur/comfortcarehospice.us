...
?><label class="sc_form_field sc_form_field_<?php echo esc_attr($args['field_name']); ?> sc_form_field_<?php echo esc_attr($args['field_type']); ?><?php echo !empty($args['field_req']) ? ' required' : ' optional'; ?>"><?php
	if (!empty($args['labels']) && trx_addons_is_on($args['labels']) && !empty($args['field_title'])) {
		?><span class="sc_form_field_title"><?php echo esc_html($args['field_title']); ?></span><?php
	}
